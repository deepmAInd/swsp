...
def make_patient_data(patient_loader: Dict[str, Callable[..., Any]], int_out_path: str) -> None:
    ...
    for subject, loader_func in patient_loader.items():
        ...
        grouped, baseline, stress, amusement = _compute_features(e4_data_dict, subject.labels, norm_type)
